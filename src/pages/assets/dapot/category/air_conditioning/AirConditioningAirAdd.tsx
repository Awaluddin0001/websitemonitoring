...
import {
  initialStateAirdevice,
  updateAirdeviceReducer,
} from "src/reducers/airConditioningReducer";
import { postNewAir } from "@/services/air_conditioning/dapotAir";
import {
...
export default function AirConditioningAirAdd() {
  ...
  const handleSubmit = (e: any) => {
    ...
    formData.append("sub_category_id", "ASC01");
    ...
    formData.append("air_flow", air_flow);
    ...
    const postnew = async (data: any) => {
      const result = await postNewAir(data, dispatch);
      if (result.success) {
        navigate(
          `/main/assets/datapotensi/category/list/airconditioning/air?page=1`
        );
      }
    };
  ...
  useEffect(() => {
    ...
    fetchType(getTypeAirconditioning, dispatch, "ASC01");
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <HeadPage title={`Aset Baru Untuk Pengatur Volume Udara`} />
          ...
          <div className={styles.sectionInput}>
            <div className={styles.posisiInput}>
              ...
              <div className={styles.inputGroup}>
                ...
                <div className={styles.containerInput}>
                  <p className={styles.textTitleInput}>Flow udara</p>
                  <input
                    type="number"
                    className={styles.inputAsset}
                    value={air_flow || ""}
                ...
                <div className={styles.containerInput}>
                  <p className={styles.textTitleInput}>Kecepatan kipas</p>
                  <input
                    type="number"
                    className={styles.inputAsset}
                    value={speed || ""}
