    ...
    <>
      <div className={styles.groupingChoice}>
        {/* <motion.div
          ...
          onClick={() => navigate("/assets/list/room")}
        >
        ...
        <motion.div
          ...
          onClick={() => navigate("/assets/list/category")}
        >
        ...
        <motion.div
          ...
          onClick={() => navigate("/assets/list/vendor")}
        >
          <img src={vendor} alt="vendor asset" />
          <h2>Vendor Tiap Data Potensi</h2>
        </motion.div>
        <motion.div
          className={styles.cardChoice}
          whileHover={{
          ...
          onClick={() => navigate("/assets/list/brand")}
        >
          <img src={brand} alt="brand asset" />
          <h2>Brand Tiap Data Potensi</h2>
        </motion.div>
      </div>
    </>
  );
