...
import { postNewCctv } from "@/services/security/dapotCctv";
...
export default function SecurityCctvAdd() {
  ...
  const handleSubmit = (e: any) => {
    ...
    const postnew = async (data: any) => {
      const result = await postNewCctv(data, dispatch);
      if (result.success) {
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <HeadPage title={`Aset Baru Untuk Cctv`} />
