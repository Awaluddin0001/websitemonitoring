...
import { postNewWallpaper } from "@/services/finishing_building/dapotWallpaper";
...
export default function FinishingWallpaperAdd() {
  ...
  const handleSubmit = (e: any) => {
    ...
    const postnew = async (data: any) => {
      const result = await postNewWallpaper(data, dispatch);
      if (result.success) {
        navigate(
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <HeadPage title={`Aset Baru Untuk wallpaper`} />
