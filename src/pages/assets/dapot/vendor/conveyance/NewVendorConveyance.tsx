...
import { postVendorConveyance } from "@/services/conveyance/dapotConveyance";
...
export default function NewVendorConveyance() {
  ...
  const submitHandler = async (e: React.FormEvent<HTMLButtonElement>) => {
    ...
    const postnew = async (
      ...
      const result = await postVendorConveyance(
        company,
        company_user_name,
        number_phone,
        dispatch
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <HeadPage title={`Input Data Vendor Conveyance`} />
