...
import { postVendorFinishingbuilding } from "@/services/finishing_building/dapotFinishingBuildings";
export default function NewVendorFinishing() {
  ...
  const submitHandler = async (e: React.FormEvent<HTMLButtonElement>) => {
    ...
    const postnew = async (
      ...
      const result = await postVendorFinishingbuilding(
        company,
        company_user_name,
        number_phone,
        dispatch
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <HeadPage title={`Input Data Vendor Building Finishing`} />
          <ErrorFetch message={isError} />
        </>
      ) : (
        <>
          <HeadPage title={`Input Data Vendor Untuk Building Finishing`} />
