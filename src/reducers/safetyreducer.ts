...
import {
  ...
  safetyDeviceListState,
  safetyDeviceState,
  SafetyVendorListState,
  PostSafetyBrand,
  PostSafetyVendor,
...
export const initialStateDevice: safetyDeviceState = {
  // Value
  asset_id: "",
  ne_id: "",
  site_id: { value: "", label: "" },
...
export const initialStateListDevice: safetyDeviceListState = {
  devices: [],
  pagination: {
    currentPage: 1,
    pageSize: 10,
...
export const initialStateListVendorSafety: SafetyVendorListState = {
  vendors: [],
  pagination: {
    currentPage: 1,
    pageSize: 10,
...
export function listVendorSafetyReducer(
  state: SafetyVendorListState,
  action: ActionType
) {
  switch (action.type) {
    case "SET_VENDORS":
...
export const initialStateUpdateSafetyVendor: PostSafetyVendor = {
  company: "",
  company_user_name: "",
  number_phone: "",
  isLoading: false,
...
export function updateSafetyVendorReducer(
  state: PostSafetyVendor,
  action: ActionType
) {
  switch (action.type) {
    case "SET_COMPANY":
