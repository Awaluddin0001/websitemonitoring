...
import {
  ...
  furnitureDeviceListState,
  furnitureDeviceState,
...
export const initialStateDevice: furnitureDeviceState = {
  // Value
  asset_id: "",
  ne_id: "",
  site_id: { value: "", label: "" },
...
export const initialStateListDevice: furnitureDeviceListState = {
  devices: [],
  pagination: {
    currentPage: 1,
    pageSize: 10,
...
export function listDeviceReducer(
  state: furnitureDeviceListState,
  action: ActionType
) {
  switch (action.type) {
    case "SET_DEVICES":
