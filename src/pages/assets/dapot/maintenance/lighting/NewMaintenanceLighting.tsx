...
import { postMaintenanceLighting } from "@/services/lighting/dapotLighting";
...
export default function NewMaintenanceLighting() {
  ...
  const submitHandler = (e: React.FormEvent<HTMLButtonElement>) => {
    ...
    const postnew = async (data: any) => {
      const result = await postMaintenanceLighting(data, dispatch);
      if (result.success) {
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <HeadPage title={`Input Data Maintenance Lighting`} />
