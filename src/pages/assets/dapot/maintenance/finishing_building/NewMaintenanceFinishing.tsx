...
import { postMaintenanceFinishingbuilding } from "@/services/finishing_building/dapotFinishingBuildings";
export default function NewMaintenanceFinishing() {
  ...
  const submitHandler = (e: React.FormEvent<HTMLButtonElement>) => {
    ...
    const postnew = async (data: any) => {
      const result = await postMaintenanceFinishingbuilding(data, dispatch);
      if (result.success) {
        navigate(
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <HeadPage title={`Input Data Maintenance Building Finishing`} />
