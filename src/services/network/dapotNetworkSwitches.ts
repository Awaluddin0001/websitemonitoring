...
export const getNetworkswitches = async (
  page: string | null,
...
export const exportNetworkswitchesCsv = async (
  page: string | null,
  dispatch: (dispatch: any) => void,
  globalFilter: string,
  nopage?: string | null
...
export const exportNetworkswitchesXlsx = async (
  page: string | null,
  dispatch: (dispatch: any) => void,
  globalFilter: string,
  nopage?: string | null
...
export const postNewNetworkswitche = async (
  data: any,
  dispatch: (dispatch: any) => void
) => {
  setLoadingAndError(dispatch);
...
export const getNetworkswitche = async (
  id: string | null,
  dispatch: (dispatch: any) => void
) => {
  if (id) {
...
export const updateNetworkswitche = async (
  data: any,
  dispatch: (dispatch: any) => void,
  deviceid: string,
  assetid: string
...
export const deleteNetworkswitche = async (
  dispatch: (dispatch: any) => void,
  deviceid: string,
  asset_id: string
) => {
