...
import { getFirewall, updateFirewall } from "@/services/network/dapotFirewalls";
...
export default function NetworkFirewallUpdate() {
  ...
  useEffect(() => {
    const getComputers = async () => {
      try {
        const data = await getFirewall(searchParams.get("id"), dispatch);
        dispatch({
          type: "GET_OTHERSC",
          payload: {
