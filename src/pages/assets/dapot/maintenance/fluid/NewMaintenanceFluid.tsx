...
import { postMaintenanceFluid } from "@/services/fluid/dapotFluid";
...
export default function NewMaintenanceFluid() {
  ...
  const submitHandler = (e: React.FormEvent<HTMLButtonElement>) => {
    ...
    const postnew = async (data: any) => {
      const result = await postMaintenanceFluid(data, dispatch);
      if (result.success) {
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <HeadPage title={`Input Data Maintenance Fluid`} />
