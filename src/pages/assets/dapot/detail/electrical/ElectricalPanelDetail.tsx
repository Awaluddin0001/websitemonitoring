...
import { getPanel } from "@/services/electrical/dapotPanels";

export default function ElectricalPanelDetail() {
        ...
        <>
          ...
          <div className={styles.detailSubCategory}>
            <div className={styles.cardsDetailDeck}>
              ...
              />
              <CardDetail title="Model" type="model" typeName={type_id.label} />
              <CardDetail
                title="Maintenance"
                type="maintenance"
                deviceId={asset_id}
