...
export const exportVideorecordingsCsv = async (
  page: string | null,
  dispatch: (dispatch: any) => void,
  globalFilter: string,
  nopage?: string | null
...
export const exportVideorecordingsXlsx = async (
  page: string | null,
  dispatch: (dispatch: any) => void,
  globalFilter: string,
  nopage?: string | null
...
export const postNewVideorecording = async (
  data: any,
  dispatch: (dispatch: any) => void
) => {
  setLoadingAndError(dispatch);
...
export const deleteVideorecording = async (
  dispatch: (dispatch: any) => void,
  deviceid: string,
  asset_id: string
) => {
