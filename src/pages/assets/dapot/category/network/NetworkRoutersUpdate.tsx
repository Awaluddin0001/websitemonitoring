...
import { getRouter, updateRouter } from "@/services/network/dapotRouters";
...
export default function NetworkRoutersUpdate() {
  ...
  useEffect(() => {
    const getComputers = async () => {
      try {
        const data = await getRouter(searchParams.get("id"), dispatch);
        dispatch({
          type: "GET_OTHERSC",
          payload: {
