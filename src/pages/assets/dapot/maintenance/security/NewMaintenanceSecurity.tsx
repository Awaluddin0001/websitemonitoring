...
import { postMaintenanceSecurity } from "@/services/security/dapotSecurity";
...
export default function NewMaintenanceSecurity() {
  ...
  const submitHandler = (e: React.FormEvent<HTMLButtonElement>) => {
    ...
    const postnew = async (data: any) => {
      const result = await postMaintenanceSecurity(data, dispatch);
      if (result.success) {
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <HeadPage title={`Input Data Maintenance Security`} />
