...
import { getExtinguishdevice } from "@/services/extinguish/dapotExtinguish";

export default function ExtinguishDetail() {
        ...
        <>
          ...
          <div className={styles.detailSubCategory}>
            ...
            <CardDetail
              title="Foto"
              type="foto"
              urlImage="https://192.168.1.62:2001/images/extinguish"
              imageTitle1={photo1}
              imageTitle2={photo2}
              imageTitle3={photo3}
            />
