...
import { postMaintenanceElectrical } from "@/services/electrical/dapotElectrical";
...
export default function NewMaintenanceElectrical() {
  ...
  const submitHandler = (e: React.FormEvent<HTMLButtonElement>) => {
    ...
    const postnew = async (data: any) => {
      const result = await postMaintenanceElectrical(data, dispatch);
      if (result.success) {
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <HeadPage title={`Input Data Maintenance Electrical`} />
