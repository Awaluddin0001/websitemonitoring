...
import { postMaintenanceAirconditioning } from "@/services/air_conditioning/dapotAirConditioning";
export default function NewMaintenanceAirconditioning() {
  ...
  const submitHandler = (e: React.FormEvent<HTMLButtonElement>) => {
    ...
    const postnew = async (data: any) => {
      const result = await postMaintenanceAirconditioning(data, dispatch);
      if (result.success) {
        navigate(
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <HeadPage title={`Input Data Maintenance Air Conditioning`} />
