...
import { getStorage, updateStorage } from "@/services/network/dapotStorage";
...
export default function NetworkStorageUpdate() {
  ...
  useEffect(() => {
    const getComputers = async () => {
      try {
        const data = await getStorage(searchParams.get("id"), dispatch);
        console.log(data);
        dispatch({
          type: "GET_STORAGE",
          payload: {
